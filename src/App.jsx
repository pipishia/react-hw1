...
function App() {
  return (
   <><header className="header">
    ...
    </header><article class="image__layout py-3 py-sm-5">
        <div class="container">
          ...
          <div class="row">
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img1.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 1</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img2.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 2</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img3.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 3</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img4.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 4</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img5.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 5</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img6.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 6</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img7.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 7</p>
            </div>
            <div class="image mt-4 col-sm-6 col-lg-3">
              <a href="" class="image__link">
                <img src="images/img8.jpg" alt="" class="image__style" />
              </a>
              <p class="image_title">Place 8</p>
            </div>
          </div>
        </div>
      </article><article class="description__layout py-4 py-sm-5">
